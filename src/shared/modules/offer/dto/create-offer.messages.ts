import { ApartmentType, City } from '../../../models/index.js';
import { DESCRIPTION_LENGTH, GUESTS, OFFER_IMAGES_AMOUNT, RENTAL_COST, ROOMS, TITLE_LENGTH } from '../offer.constant.js';
...
export const CREATE_OFFER_MESSAGES = {
  ...
  HOUSING_PHOTOS: {
    ...
    MAX_LENGTH: 'Too short for field «images»',
